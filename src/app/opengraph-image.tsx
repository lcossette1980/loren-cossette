...
export const alt = "Loren Cossette — AI Program Architect";
    ...
    (
      <div
        style={{
          ...
          background: "linear-gradient(135deg, #0a0a0f 0%, #0d0d1a 40%, #111122 100%)",
          padding: "80px",
          position: "relative",
          overflow: "hidden",
        }}
      >
        ...
        >
          Embedded AI leadership for organizations undergoing modernization.
          Currently running 5 production AI initiatives at Multnomah County.
        </p>
        ...
        >
          ...
          >
            {["NLP", "Deep Learning", "Agentic AI", "RAG", "Full-Stack"].map(
              (tech) => (
                <span
                  key={tech}
                  style={{
